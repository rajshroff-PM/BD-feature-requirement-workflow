...
export const LoginScreen: React.FC<LoginScreenProps> = () => {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            setMessage({ type: 'error', text: error.message || 'Error connecting to Google' });
            setLoading(false);
        }
    };
                    ...
                    <form className="space-y-6" onSubmit={handleAuth}>
                        ...
                        <div>
                            <button
                                ...
                                disabled={loading}
                                className="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 disabled:opacity-50 transition-colors"
                            >
